...
\end{frame}
    ...
    \begin{frame}[t]
        \frametitle{Flickr 1}
        \begin{center}
            \includegraphics[height=0.9\textheight]{explore-cc-photos-on-flickr.png}
        \end{center}
    \end{frame}
    \begin{frame}[t]
        \frametitle{Flickr 2}
    ...
    \begin{frame}[t]
        \frametitle{Flickr 7}
        \begin{center}
            \includegraphics[height=0.9\textheight]{request-to-license2.png}
        \end{center}
    \end{frame}
    \begin{frame}[t]
        \frametitle{Flickr 8}
        \begin{center}
            \includegraphics[height=0.9\textheight]{select-cc-license-for-your-photo-on-flickr.png}
        \end{center}
    \end{frame}
    \begin{frame}[t]
        \frametitle{Flickr 9}
    ...
    \begin{frame}[t]
        ...
        \begin{center}
            \includegraphics[height=0.9\textheight]{view-photo-and-see-cc-license.png}
        \end{center}
    \end{frame}
    \begin{frame}[t]
        \frametitle{Flickr 12}
        \begin{center}
            \includegraphics[height=0.9\textheight]{view-your-own-photo-on-flickr.png}
        \end{center}
    \end{frame}
    \begin{frame}[t]
